...
function StatCard(props) {
  ...
  return (
    <div className="bg-neutral-950 hover:bg-neutral-900 border border-neutral-800 p-4 rounded-xl text-center transition-all duration-300 w-full lg:w-2xs mb-5 lg:mb-0">
