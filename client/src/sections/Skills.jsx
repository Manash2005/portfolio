    ...
    <section id="skills" className="relative min-h-screen overflow-hidden pt-20 md:pt-28 pb-16 w-full">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-12">
          ...
          {/* Right Column: Coding Profiles (5 cols) */}
          <div className="lg:col-span-5 space-y-6">
            <div className="flex items-center justify-between border-b border-white/10 pb-3 mb-2">
              ...
              <span className="text-xs text-secondary font-mono">Live statistics</span>
            </div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative overflow-hidden border border-white/10 bg-neutral-950/40 backdrop-blur-md rounded-2xl p-6 flex flex-col items-center justify-center text-center shadow-[0_0_50px_rgba(194,61,41,0.02)]"
            >
